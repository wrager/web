...
Triangle.prototype.calculateArea = function() {
    ...
    second = this._getSide(new Position(this._x2, this._y2), new Position(this._x3, this._y3));
    third = this._getSide(new Position(this._x1, this._y1), new Position(this._x3, this._y3));
	return Math.abs(Math.sqrt(perimeter * (perimeter - first) * (perimeter - third) * (perimeter - second)));
};

Triangle.prototype.calculatePerimeter = function() {
	first = this._getSide(new Position(this._x1, this._y1), new Position(this._x2, this._y2));
	third = this._getSide(new Position(this._x1, this._y1), new Position(this._x3, this._y3));
	second = this._getSide(new Position(this._x2, this._y2), new Position(this._x3, this._y3));
