...
var canvas = <HTMLCanvasElement>getElement("canvas");
var circle;
var rectangle;
var triangle;
...
function getElementValue(id) {
    return (<HTMLInputElement>getElement(id)).value;
}
...
function getSelectorValue() {
    var selector = <HTMLSelectElement>getElement("shape-selector");
    return (<HTMLSelectElement>selector).options[selector.selectedIndex].value;
}