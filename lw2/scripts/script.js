...
function onShapeSelect() {
    ...
    hide("circle-parametrs-form");
    hide("rectangle-parametrs-form");
    hide("triangle-parametrs-form");
    show("apply-btn");

    var selectedValue = getSelectorValue();
    if (selectedValue == "Circle") {
        show("circle-parametrs-form");
    } else if (selectedValue == "Rectangle") {
        show("rectangle-parametrs-form");
    } else if (selectedValue == "Triangle") {
        show("triangle-parametrs-form");
    }
}
...
function drawShapeInfo(context, shape, shift) {
    ...
    context.fillText(shape.constructor.name, 700, shift * FONT_SIZE * 2);
    context.fillText("Perimeter: " + shape.calculatePerimeter(), 700, shift * FONT_SIZE * 2 + FONT_SIZE);
    context.fillText("Area: " + shape.calculateArea(), 700, shift * FONT_SIZE * 2 + FONT_SIZE * 2);
}
